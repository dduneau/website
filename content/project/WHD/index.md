...
In collaboration with [Jean-Baptiste Ferdy](https://edb.cnrs.fr/annuaire/jean-baptiste-ferdy/), we have used theoretical model and experimental approach to define more specifically the parameters of the infections and determine their role in the two strategies to survive an infection (i.e. controlling the infection - resistance- versus the tolerance of the damage linked to the infection - disease tolerance) [Duneau et al. eLife 2025](https://elifesciences.org/articles/104052). This work aims to finely describe the dynamics of bacteria interacting with the hosts, understand appropriately the parameters, and to compare dynamics statistically.
...
{{< figure src="mbio_tradeoff.jpg" title="Negative correlation between proliferation early in the infection and in dead hosts." width="300" height="300">}}
