...
Some Pasteuria genotypes were able to infect the host without attaching to the oesophagus. Before the end of my PhD, I found that those genotypes were able to go through the gut and attach to the hindgut before being released. In collaboration with Gilberto Bento and [Peter Field](https://scholar.google.com/citations?hl=en&user=fx8N28YAAAAJ&view_op=list_works&sortby=pubdate), we showed that this alternative strategy had a different genetic basis and opened a whole area of research [Bento et al. 2020](Bento_Heredity_2020.pdf).
